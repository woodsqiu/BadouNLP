...
def item_cf(user_id, item_id, similar_items, user_to_rating):
    print("similar items:", similar_items[user_id])
    pred_score = 0
    count = 0
    for similar_item, similarity in similar_items[item_id - 1][:10]:
...
if __name__ == "__main__":
    user_item_score_data_path = "/Users/jessicachan/nlp20/week17_推荐系统/ml-100k/u.data"
    item_name_data_path = "/Users/jessicachan/nlp20/week17_推荐系统/ml-100k/u.item"
    ...
    print("相似用户计算完成，耗时：", time.time() - start_time)
    # while True:
